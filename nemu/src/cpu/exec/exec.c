...
opcode_entry opcode_table [512] = {
  /* 0x00 */	IDEX(G2E, add), IDEX(G2E, add), IDEX(E2G, add), IDEX(E2G, add),
  ...
  /* 0x68 */	IDEX(I, push), EMPTY, IDEXW(I, push, 1), IDEX(SI_E2G, imul3),
  ...
  /* 0xe8 */	IDEXW(I , call, 4), IDEXW( J,jmp, 4), EMPTY, IDEXW(J, jmp, 1),
